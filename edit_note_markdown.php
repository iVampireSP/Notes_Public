...
<div id="mainContent">
    ...
    <form name="editnote" method="post" action="edit_note_markdown.php">
        <div class="mdui-textfield mdui-textfield-floating-label">
            <label class="mdui-textfield-label">标题</label>
            <input name="title" class="mdui-textfield-input" value="<?php echo $user->getTitle(); ?>" type="text" autocomplete="off" autofocus required />
        </div>
        ...
        <br /><br /><br />
        <!-- 不知道放哪了 -->
        <input type="text" name="noteid" style="display: none;" value="<?php echo $_GET['noteid']; ?>" />
        <div class="mdui-col">
            <button class="mdui-fab mdui-fab-fixed mdui-color-theme-accent" type="submit"><i class="mdui-icon material-icons">save</i></button>
        </div>
    </form>
</div>
<?php
